...
import { X, FileText, MessageCircle, Download, Eye, ChevronUp, ChevronDown } from "lucide-react";
  ...
  return (
    <div className="fixed inset-0 z-50 bg-background flex flex-col">
      ...
      <header className="flex items-center justify-between px-4 py-3 border-b bg-background">
        <h1 className="font-semibold text-foreground line-clamp-1 flex-1 mr-4">
          {lesson.title}
        </h1>
