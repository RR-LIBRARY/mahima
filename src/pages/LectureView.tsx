    ...
    >
      ...
      <div className="flex-1">
        ...
        <button
          ...
          className="mt-2 px-4 py-1.5 bg-primary text-primary-foreground text-sm font-medium rounded-lg hover:bg-primary/90 transition-colors"
        >
          {getActionLabel()}
        </button>
      </div>
          ...
          <div className="flex-1 flex items-center justify-center p-4">
            <div className="w-full max-w-6xl">
              {isDriveOrPdf(currentLesson.videoUrl) ? (
                ...
                <PremiumVideoPlayer videoUrl={currentLesson.videoUrl} />
              )}
            </div>
          </div>
        </div>
