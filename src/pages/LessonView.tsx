...
import { 
  ...
  Loader2, FileText, MessageCircle, Star, CheckCircle, Send, Library
} from "lucide-react";
...
const LessonView = () => {
  ...
  // Comments hook
  const { comments, loading: commentsLoading, createComment, fetchComments } = useComments(currentLesson?.id);
  ...
  const handlePostComment = async () => {
    ...
    const success = await createComment(
      { lessonId: currentLesson.id, message: newComment.trim() },
